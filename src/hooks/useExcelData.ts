...
export const useExcelData = () => {
  ...
  const loadExcelData = async () => {
    try {
      ...
      setError("Failed to load content data from Excel files. Please check if the Excel files exist in /public/excel/ directory.");

      // No fallback data - system should only use Excel files
      console.error("Excel files not found or corrupted. Please ensure translations.xlsx and cars.xlsx exist in /public/excel/ directory.");
