export const de = {
  ...
  footer: {
    company: {
      ...
      description:
        "Ihr vertrauensvoller Partner für Premium-Fahrzeuge in Deutschland. Seit 2008 bieten wir erstklassige Qualität und Service.",
  ...
  advantageItems: [
    ...
    },
    {
      ...
      description: "Kompetente Beratung auf Deutsch, Englisch und Farsi",
    },
  ],
  // Car detail labels
  carLabels: {
